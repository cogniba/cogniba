...
export default function MobileSidebar() {
  ...
  return (
    <>
      ...
      <nav
        className={cn(
          "pointer-events-auto fixed inset-0 z-40 flex h-screen w-screen flex-col justify-between bg-background/80 pt-28 text-lg font-semibold backdrop-blur-md transition-all duration-300",
          !isSidebarOpen &&
